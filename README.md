...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">amkay97.github.io</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Masters</a></li>
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="hero-title mb-4">I am Amy Farnan</h1>
          <p class="hero-subtitle"><span class="typed" data-typed-items="Cyber Security Professional, Masters Student at University of Essex"></span></p>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name: </span> <span>Amy Farnan</span></p>
                        <p><span class="title-s">Profile: </span> <span>Cyber Security Professional</span></p>
                        <p><span class="title-s">Email: </span> <span>amyfarnan97@gmail.com</span></p>
                  ...
                  <div class="skill-mf">
                    ...
                    <span>Network Infrastructure</span> <span class="pull-right">75%</span>
                    <div class="progress">
          ...
          <div class="col-md-4">
            <div class="service-box">
              ...
              <div class="service-content">
                <h2 class="s-title">[Launching Into Cyber Security]</h2>
